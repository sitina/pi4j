 ...
 * FILENAME      :  ParallelStepperMotorExample.java  
 * 
...
public class ParallelStepperMotorExample {

    private static class MotorRunnable implements Runnable {
        ...
        public MotorRunnable(GpioPinDigitalOutput[] pins) {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        final GpioPinDigitalOutput[] pins2 = {
        ...
        Thread m1 = new Thread(new MotorRunnable(pins1));
        Thread m2 = new Thread(new MotorRunnable(pins2));
